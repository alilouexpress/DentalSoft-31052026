    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              />
              <span className="absolute right-3 top-1/2 -translate-y-1/2 text-sm font-bold text-sky-600 pointer-events-none">DA</span>
            </div>
        ...
        <DialogFooter className="gap-2">
          ...
          <Button size="sm" onClick={handleSave} disabled={saving || unpaidInvoices.length === 0} className="bg-sky-600 hover:bg-sky-700 text-white cursor-pointer gap-1.5">
